# -*- coding: utf-8 -*-
"""4_eda-sql-coursera_sqllite.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ubwq9Kj1fwegJ-xdYQWAYCFickU3KuZl
...
# Commented out IPython magic to ensure Python compatibility.
# %sql select PAYLOAD_MASS__KG_ from SPACEXTBL \
...
# Commented out IPython magic to ensure Python compatibility.
# %sql select substr(Date,4,2) as Months, Booster_Version, Payload, Mission_Outcome from SPACEXTBL \
...
# Commented out IPython magic to ensure Python compatibility.
# %sql select Mission_Outcome, Date from SPACEXTBL \
