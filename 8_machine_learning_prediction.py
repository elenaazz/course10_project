...
Original file is located at
    https://colab.research.google.com/drive/1OUqkSCcpS8ZQXu8pD3BcJd5S34DzGvKo
...
accuracy_dict['SVM']= svm_cv.score(X_test,Y_test)
accuracy_dict
...
accuracy_dict['Decision Tree']= tree_cv.score(X_test,Y_test)
...
print('accuracy on test set', knn_cv.score(X_test,Y_test))

accuracy_dict['k nearest neighbors'] = knn_cv.score(X_test,Y_test)
...
plt.bar(range(len(accuracy_dict)), values, tick_label=names, color=['cyan', 'red', 'green', 'blue'])
plt.show()
