...
Original file is located at
    https://colab.research.google.com/drive/1O1rBOCzwSSYq-bJViaGp8OIeQTtwgY-T
...
extract_column_from_header(elements[0])
# Iterate each th element and apply the provided extract_column_from_header() to get a column name
for i in range(len(elements)):
 name= extract_column_from_header(elements[i])
