...
Original file is located at
    https://colab.research.google.com/drive/1fKr-06T5PPwirWntK9c37tD0xYcPJ4fq
...
#to display missing values for each column
...
data_falcon9['PayloadMass'] = data_falcon9['PayloadMass'].fillna(mean_Val)
...
#to export the dataframe into a csv without indexing 
